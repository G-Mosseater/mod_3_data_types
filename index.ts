...
// after compiling the code we use node index.js to run our JS code
...
let youAreAwesome: boolean;   // sets true value for variable
youAreAwesome = true;

if (youAreAwesome === true) {  // if statement checks if the value is true
  console.log('Nice')    // if so, prints Nice
} else {
  console.log('Not cool man!') // if not prints Not cool man!
}
console.log(youAreAwesome)  // outputs our message to the terminal
